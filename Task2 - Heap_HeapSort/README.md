...
This system aim at demonstrate a simple heap sort in job priorittzing.


## Updates
- 24 Feb 2026 - Draft of this document
- 11 Apr 2026 - Main Function updated
- 12 Apr 2026 - Update this document
...
cd COMP8090---Project
cd "Task2 - Heap_HeapSort"
streamlit run HeapJob.py
```

## Quick Start
- User can change or add the priority and jobs they need into the jobs list as (prioirty, job name) in the following section inside the program
...
## Contact
For questions about code or paper, please email cheng.hm.73@gmail.com
